        ...
        val nodeListenerFuture = object : RecaptchaEnterpriseNodeListener(
            ...
            override fun onCallbackReceived(node: Node)  {
                ...
                if (node.getCallback(TextOutputCallback::class.java) != null) {
                    ...
                    val androidPackageName = jsonObject.getJSONObject("tokenProperties").getString("androidPackageName")
                    ...
                    Assertions.assertThat(androidPackageName).isEqualTo("org.forgerock.android.integration.test")
        ...
        val nodeListenerFuture = object : RecaptchaEnterpriseNodeListener(
            ...
            override fun onCallbackReceived(node: Node) {
                ...
                if (node.getCallback(TextOutputCallback::class.java) != null) {
                    ...
                    val transactionId = jsonObject.getJSONObject("event").getJSONObject("transactionData").getString("transactionId")
                    val paymentMethod = jsonObject.getJSONObject("event").getJSONObject("transactionData").getString("paymentMethod")
                    val cardBin = jsonObject.getJSONObject("event").getJSONObject("transactionData").getString("cardBin")
                    val cardLastFour = jsonObject.getJSONObject("event").getJSONObject("transactionData").getString("cardLastFour")
                    ...
                    val accountId = jsonObject.getJSONObject("event").getJSONObject("userInfo").getString("accountId")
